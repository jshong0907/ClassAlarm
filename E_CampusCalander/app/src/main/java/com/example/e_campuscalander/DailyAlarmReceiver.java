...
public class DailyAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // 작동할 액티비티를 설정한다
        Intent alarmIntent = new Intent(context, DailyActivity.class);
        alarmIntent.putExtra("user_id", intent.getStringExtra("user_id"));
        alarmIntent.putExtra("user_pw", intent.getStringExtra("user_pw"));
